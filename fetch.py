#!/usr/bin/env python3
"""
Recupero codici sconto Dyson da shopilo.it
Sursa: https://shopilo.it/negozi/dyson.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/dyson.it"
STORE_NAME = "Dyson"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Dyson da shopilo.it"""
    headers = {
