#!/usr/bin/env node
/**
 * Fetch coduri reducere Dyson de pe shopilo.it
 * Homepage: https://shopilo.it/magazin/dyson.it
 */

const SHOPILO_URL = "https://shopilo.it/magazin/dyson.it";
const STORE_NAME  = "Dyson";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-it/codice-sconto-dyson)" }
  });
